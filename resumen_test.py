...
def test_atributos():
    ...
    l2:list[Participante]=crear_lista_participantes('rmet.csv',5)
    ...
    l3:list[Participante]=(crear_lista_participantes('rmet.csv',10)[5:9])
...
def test_eq():
    ...
    l2:list[Participante]=crear_lista_participantes('rmet.csv',5)
    r2:Resumen=Resumen(l2)
    l3:list[Participante]=crear_lista_participantes('rmet.csv',2)
    r3:Resumen=Resumen(l3)
    assert not r1==r2
    assert r1==r3
